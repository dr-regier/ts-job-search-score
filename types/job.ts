...
export interface Job {
  ...
  /** Tailored resume data for this specific job */
  tailoredResume?: {
    /** Resume content in markdown format */
    content: string;

    /** Name of the master resume used as base */
    masterResumeName: string;

    /** ISO timestamp when resume was generated */
    generatedAt: string;

    /** List of changes made to the master resume */
    changes: Array<{
      type: "reorder" | "keyword" | "emphasis" | "summary" | "trim" | "section_move";
      description: string;
    }>;

    /** Analysis of how well the resume matches the job */
    matchAnalysis: {
